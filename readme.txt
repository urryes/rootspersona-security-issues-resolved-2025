...
Github link forked version: https://github.com/urryes/rootspersona-security-issues-resolved-2025/
Donate link: https://rootspersona.com - not work
Tags: roots, genealogy, GEDCOM, ancestors, family
Requires at least: 3.0
Tested up to: 6.0
Stable tag: 3.7.6

Rootsersona creates one or more pages of family history using data imported from a GEDCOM file (version 5.5).
...
<li> <a href="https://rootspersona.com" title="Demo Site">New Demo Site</a></li>
</ul>
...
=======
 = 3.7.6 Forked =
* Security issues fixed by Yury Fisenko
*
