                    ...
                    if ( !isset( $persons ) || count( $persons ) == 0 ) {
                        ...
                        foreach ( $persons as $p ) {
                            ...
                            if ( $pageId != false ) {
                                ...
                                $msg = $msg . '<br/>'
                                    /* translators: Number of pages created by the Rootpersona*/   
...
// SVG Tree Export Module
if ( is_admin() ) {
    require_once ROOTSPERSONA_PLUGIN_DIR . '/admin/class-rootspersona-svg-admin.php';
}
require_once ROOTSPERSONA_PLUGIN_DIR . '/includes/class-rootspersona-svg-generator.php';
